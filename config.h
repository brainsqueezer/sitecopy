...
#define PACKAGE_STRING "sitecopy 0.16.3"
...
/* Define to compile the WebDAV protocol driver */
#define USE_DAV 1

/* Define to compile the FTP protocol driver */
#define USE_FTP 1
...
/* Define to compile the rsh/rcp protocol driver */
#define USE_RSH 1

/* Define to compile the sftp/ssh protocol driver */
#define USE_SFTP 1
...
/* Define to be the type of the third argument to getsockname */
